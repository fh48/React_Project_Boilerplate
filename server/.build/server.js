...
/******/ 	var hotCurrentHash = "b0cff38687df5c560a7e"; // eslint-disable-line no-unused-vars
...
app.get('/api', function (req, res) {
    res.send({
        message: 'I am a server Route, nice!' + ' and can also be hot reloaded!'
    });
});
